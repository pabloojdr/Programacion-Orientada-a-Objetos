...
public class Asignatura {
	...
	/*private void procesarEntradasSplit(String[] entradas) {
		for (String entrada : entradas) {
			try {
				...
				errores.add("ERROR. Nota no numérica: " + entrada);

			} catch (ArrayIndexOutOfBoundsException e) {
				errores.add("Error. Faltan datos: " + entrada);

			} catch (AlumnoException e) {
				errores.add("ERROR. " e.getMessage() + ": " + entrada);
	...
	*/
	...
	/*private void procesarEntradaScanner(String[] entradas) {
		for(String entrada : entradas) {
			try (Scanner)
		}
	}
