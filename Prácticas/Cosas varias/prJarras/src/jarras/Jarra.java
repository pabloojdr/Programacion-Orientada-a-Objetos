...
public class Jarra {
	...
	public void llenaDesde(Jarra j) {
		...
		int trasvase = Math.min(this.capacidad - this.contenido, j.contenido); 	// this. es la jarra que quiero llenar.
																				// j. es la jarra desde la que lleno.

		this.contenido += trasvase;
		j.contenido -= trasvase;
	}

	@Override 												// Sirve para decirle a Java que sabemos que estamos redefiniendo el método
															// "toStringde" la clase "Object" (Está relacionado con la herencia en Java)
	
	public String toString() { 								// Es el método toString. Tiene que llamarse así siempre
		return "J(" + capacidad + ", " + contenido + ")"; 	// El enunciado nos dice que tiene que aparecer en pantalla
															// J(capacidad, contenido), para ello encadenamos strings
															// con "+"
	}
